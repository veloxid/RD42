...
ChannelScreen::ChannelScreen(UInt_t det)
{
	this->det = det;
...
void ChannelScreen::PrintScreenedChannels() {
	std::vector<Int_t> screenedChannels;
	int nChannels = TPlaneProperties::getNChannels(det);
//	std::cout<<"Print Screened Channels: "<<nChannels<<std::endl;
