...
#	rd42Style.SetOptFit(1)
	...
	# rd42Style.SetStatStyle(Style_t style = 1001) 
	# rd42Style.SetStatX(Float_t x = 0) 
	# rd42Style.SetStatY(Float_t y = 0) 

	# margins
	rd42Style.SetPadTopMargin(0.05) 
	rd42Style.SetPadBottomMargin(0.13) 
	rd42Style.SetPadLeftMargin(0.13) 
	rd42Style.SetPadRightMargin(0.05) 
	...
	rd42Style.SetTitleSize(0.05, "XYZ") 
	# rd42Style.SetTitleXSize(Float_t size = 0.02)  # Another way to set the size?
	# rd42Style.SetTitleYSize(Float_t size = 0.02) 
	rd42Style.SetTitleXOffset(1.) 
	rd42Style.SetTitleYOffset(1.4) 
	# rd42Style.SetTitleOffset(1.1, "Y")  # Another way to set the Offset

	# axis labels
	rd42Style.SetLabelColor(1, "XYZ") 
	rd42Style.SetLabelFont(42, "XYZ") 
	rd42Style.SetLabelOffset(0.007, "XYZ") 
	rd42Style.SetLabelSize(0.05, "XYZ") 
